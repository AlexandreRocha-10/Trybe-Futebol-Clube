...
- Você deve criar uma branch no seguinte formato: `nome-de-usuario-nome-do-projeto`
  * Exemplo: `git checkout -b maria-sd-026-a-trybe-futebol-clube`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-026-a-trybe-futebol-clube`
...
- `sd-026-a-trybe-futebol-clube/app/backend/package.json`
...
<details>
  ...
  - Vá até a página DO SEU Pull Request, adicione a label de "code-review" e marque seus colegas
    ...
    - No menu à direita, clique no *link* "Reviewers" e digite students, selecione o time tryber/students-sd-026-a
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH26-A&template=betrybe/sd-0x-trybe-futebol-clube)
...
## Database
  ...
  - A leitura da seção `Model com Sequelize` no conteúdo de `TypeScript: Tipagem Estática e Generics` é recomendada;
